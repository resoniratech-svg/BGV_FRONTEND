...
function CandidateVerificationCenter() {
  ...
  const [_ocrResult, setOcrResult] = useState<any>(null);
  const [_showOCRResult, setShowOCRResult] = useState(false);
  const [_faceMatchRisk, setFaceMatchRisk] = useState("LOW");
  const [_salarySlipDecision, setSalarySlipDecision] = useState("Verified");
